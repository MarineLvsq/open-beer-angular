...
},{"./addons/drag":1,"./addons/modal":2,"./addons/modalService":3,"./addons/notDeletedFilter":4,"./addons/sortBy":5,"./beers/beersModule":8,"./config":11,"./config/configModule":13,"./mainController":14,"./save/saveController":15,"./services/rest":16,"./services/save":17}],7:[function(require,module,exports){
	module.exports=function($scope,rest,$timeout,$location,config,$route,save) {
		$scope.data={load:false};
...
},{"./beersController":7,"./beerAddController":9,"./beerUpdateController":10}],9:[function(require,module,exports){
	module.exports=function($scope,config,$location,rest,save,$document,modalService) {
